...
class LearnAboutMeSettingsPage extends StatefulWidget {
  ...
  @override
  _LearnAboutMeSettingsPageState createState() =>
      _LearnAboutMeSettingsPageState();
}
...
class _LearnAboutMeSettingsPageState extends State<LearnAboutMeSettingsPage> {
  ...
  Future<Map<String, dynamic>> fetchLearnAboutMeInfo() async {
    try {
      var response = await http.get(
        Uri.parse(
            'http://10.0.2.2:5000/api/users/${widget.userId}/get-learn-about-me-info'),
      );
      ...
      if (response.statusCode == 200) {
        ...
        print(
            'Failed to fetch learn about me information. Status code: ${response.statusCode}');
        return {};
      }
    } catch (e) {
  ...
  Future<void> saveLearnAboutMeInfo() async {
    try {
      var response = await http.put(
        Uri.parse(
            'http://10.0.2.2:5000/api/users/${widget.userId}/learn-about-me'),
      ...
      if (response.statusCode == 204) {
        ...
        print(
            'Failed to save learn about me information. Status code: ${response.statusCode}');
      }
    } catch (e) {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Μάθε για Εμένα: Ρυθμίσεις'),
      ),
      body: Padding(
              ...
              return Column(
                ...
                children: [
                  TextField(
                    ...
                    decoration: InputDecoration(labelText: 'Εικόνα'),
                  ),
                  TextField(
                    controller: descriptionController,
                    decoration: InputDecoration(labelText: 'Μάθε για Εμένα!'),
                  ),
                  TextField(
